...
## term2_ay
This function converts given terms to respective AY. Refer above for the academic year and its terms encoding. The function can take up either character or integer term encoding. 
...
This function calculates the number of academic terms between a `start_term` and an `end_term`. It assumes a standard academic year with three terms (Fall, Spring, Summer), where terms are represented by a four-digit year
